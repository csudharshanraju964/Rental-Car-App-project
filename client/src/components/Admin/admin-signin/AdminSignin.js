...
function AdminSignin({setAuth}) {
  ...
  const onUserSignin = async () => {
    ...
    try {
      ...
      const response = await axios.post(AdminSigninURL, userObj)
      toast.dismiss()
      ...
      <div className='signinbody-right'>
        <div className='signin-form-Wrapper'>
          <div className='form-navbar'>
            <div className='form-navbar-toggles'><h3 style={{ color: '#4E94F4' }} onClick={() => { navigate('/') }}>Admin</h3></div>
          ...
          <div className='signin-form'>
            ...
            <div className='form-footer'>
              <p className='signin' onClick={() => { navigate('/admin-registration') }}>Create new account</p>
